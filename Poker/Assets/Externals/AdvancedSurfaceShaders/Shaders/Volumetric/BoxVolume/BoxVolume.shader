Shader "Advanced SS/Volumetric/Box Volume" {
  Properties
  {
    ...
    _BoxMin ("Box Min (X,Y,Z) Texture Scale", Vector)   = (0,0,0,10)
    _BoxMax ("Box Max(X,Y,Z) Texture Y Speed", Vector)                  = (1,1,1,-0.1)
