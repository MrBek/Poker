...
public class SphereVolume : MonoBehaviour
{
    ...
    public Texture2D fogTexture = null;
    public float fogTextureScale = 10f;
    public float fogTextureYMovement = 0.1f;
    ...
    private Texture2D previousFogTexture = null;
    private float previousFogTextureScale = 10f;
    private float previousFogTextureYMovement = 0.1f;
    ...
    void LateUpdate()
    {
        ...
        if (radius != previousRadius ||
            ...
            fogTexture != previousFogTexture ||
            fogTextureScale != previousFogTextureScale ||
            fogTextureYMovement != previousFogTextureYMovement)
        {
            previousRadius = radius;
            previousVisibility = visibility;
            previousVolumeColor = volumeColor;
            thisTransform.localScale = forcedLocalScale;
            previousFogTexture = fogTexture;
            previousFogTextureScale = fogTextureScale;
            previousFogTextureYMovement = fogTextureYMovement;
            UpdateVolume();
        }
    }
    ...
    public void UpdateVolume()
    {
        ...
        if (materialInstance)
        {
            materialInstance.SetVector("_TextureData", new Vector4((1f / fogTextureScale), fogTextureYMovement, 0f, 0f));
